...
namespace QuanLyThueXe.Controllers.Public
{
    public class PublicCarController : Controller
    {
        ...
        public ActionResult Search(int page, string name, string idType)
        {
            ...
            {
                ViewBag.List = vehicleDao.SearchByType(page, 9, idType);
                ViewBag.tag = page;
                ViewBag.key = 1;
            ...
            {
                ViewBag.List = vehicleDao.SearchByName(page, 9, name);
                ViewBag.tag = page;
                ViewBag.key = 2;
                ViewBag.name = name;
            ...
            else if (name != null && idType != null)
            {
                ...
                ViewBag.List = vehicleDao.SearchByTypeAndName(page, 9, idType, name);
                ViewBag.tag = page;
                ViewBag.key = 3;
                ViewBag.name = name;
